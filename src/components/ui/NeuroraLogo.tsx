...
const NeuroraLogo: React.FC<NeuroraLogoProps> = ({ className = "h-8 w-auto" }) => {
  return (
    <svg
      ...
      className={className}
    >
      <rect width="520" height="80" fill="transparent" />

      <g transform="translate(0, 0)">
        {/* Neurora Tech Logo */}
        <g transform="scale(0.075) translate(100, -100)">
        ...
        <g transform="translate(100, -10)">
          <defs>
            ...
            <pattern
              ...
              height="64"
            >
              <rect width="100%" height="4" y="0" fill="currentColor" />
              <rect width="100%" height="4" y="7" fill="currentColor" />
              <rect width="100%" height="8" y="14" fill="currentColor" />
              <rect width="100%" height="12" y="25" fill="currentColor" />
              <rect width="100%" height="20" y="40" fill="currentColor" />
            </pattern>
          </defs>
